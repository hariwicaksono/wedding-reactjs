...
class Pengaturan extends Component {
    ...
    render() {
        ...
        <div className="mx-auto text-center" style={{marginTop: '-15px'}} >
        <h1 className="text-center mb-0">{res.nama_web}</h1>
        <h1 className="text-center display-2 mb-0" style={{lineHeight: '45px'}}><strong>{res.nama_pengantin}</strong></h1>
